...
def test_persona_profiles_creation():
    solo_profile = PersonaOntologyEngine.create_persona_profile(
        counterpart_name="", role_title="", power_axis=PowerAxis.SOLO
    )
    ...
    casual_profile = PersonaOntologyEngine.create_persona_profile(
        counterpart_name="Alex", role_title="Friend / Colleague", power_axis=PowerAxis.CASUAL
    )
    ...
    conflict_profile = PersonaOntologyEngine.create_persona_profile(
        counterpart_name="Vendor Lead", role_title="Negotiation Counterpart", power_axis=PowerAxis.CONFLICT
    )
    ...
    upward_profile = PersonaOntologyEngine.create_persona_profile(
        counterpart_name="Engineering Director", role_title="Senior Director", power_axis=PowerAxis.UPWARD
    )
    ...
    lateral_profile = PersonaOntologyEngine.create_persona_profile(
        counterpart_name="Product Manager", role_title="Staff PM", power_axis=PowerAxis.LATERAL
    )
    ...
    downward_profile = PersonaOntologyEngine.create_persona_profile(
        counterpart_name="Software Engineer", role_title="Associate Engineer", power_axis=PowerAxis.DOWNWARD
    )
...
def test_system_instruction_generation():
    profile = PersonaOntologyEngine.create_persona_profile(
        counterpart_name="VP of Engineering", role_title="VP of Engineering", power_axis=PowerAxis.UPWARD
    )
