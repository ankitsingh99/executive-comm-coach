...
def sample_session():
    dialogue = [
        ...
        Utterance(
            ...
            start_time=3.2,
            end_time=9.0,
            transcript="Basically, matlab I just think maybe we could ship next week.",
        ),
        ...
        Utterance(
            ...
            start_time=13.2,
            end_time=20.0,
            transcript="Understood. Our data demonstrates that the build is stable and we have decided to ship on Thursday morning.",
        ),
    ]
...
def test_schema_constraints_and_bounds():
    ...
    strength = TopStrength(
        observation="Strong and decisive delivery.", verbatim_quote="Our data demonstrates that the build is stable."
    )
